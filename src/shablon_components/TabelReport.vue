<template>
  <div class="!flex h-full w-full flex-col gap-4 p-5">
    ...
    <div class="relative flex-1">
      ...
      <div v-if="rows && rows.length < 1" class="flex w-full flex-col no-wrap items-center gap-3 py-16 absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
...
- Шаблон компонента: src/shablon_components/TabelReport.vue — используй как основу структуры.
